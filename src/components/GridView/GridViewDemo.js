/**
 * Created by peterk on 7/14/2017.
 */
...
class GridViewDemo extends React.Component {
    constructor(props) {
        super(props);
    ...
    _renderGridView() {
        const renderGridViewItem = (item, sectionID, rowID, itemIndex, itemID)  => {
            ...
            return (
                <View
                    ...
                    <Text style={{ fontSize: randomValue }}>
                        <Text>{`${item.text} (${sectionID}-${rowID}-${itemIndex}-${itemID})`}</Text>
                    </Text>
                </View>
            );
        };
